...
class BaseFileHelper
{
     ...
     *   For example, "views/*.php" matches "views/Lists.php" but not "views/controller/Lists.php".
     *   A leading slash matches the beginning of the pathname. For example, "/*.php" matches "Lists.php" but not "views/start/Lists.php".
