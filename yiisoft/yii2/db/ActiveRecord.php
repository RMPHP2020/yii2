...
class ActiveRecord extends BaseActiveRecord
{
    ...
    public static function updateAll($attributes, $condition = '', $params = [])
    {
        ...
        static::$command = $command->update(static::tableName(), $attributes, $condition, $params);
    ...
    public static function updateAllCounters($counters, $condition = '', $params = [])
    {
        ...
        $command = static::getDb()->createCommand();
        static::$command = $command->update(static::tableName(), $counters, $condition, $params);
    ...
    {
        $command = static::getDb()->createCommand();
        static::$command = $command->delete(static::tableName(), $condition, $params);
     ...
     * ~~~
     *
     * The above declaration specifies that in the "test" scenario, the insert operation ([[insert()]])
    ...
    protected function insertInternal($attributes = null)
    {
        ...
        $db = static::getDb();
        static::$command = $command = $db->createCommand()->insert($this->tableName(), $values);
        if (!$command->execute()) {
            return false;
        }
