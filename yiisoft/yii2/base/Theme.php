 ...
 * then the themed version for a view file `@app/views/site/Lists.php` will be
 * `@app/themes/basic/site/Lists.php`.
 *
 ...
 * ~~~
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/Lists.php` or
 * `@app/themes/basic/site/Lists.php`. The former has precedence over the latter if both files exist.
 *
